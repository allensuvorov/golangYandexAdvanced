/*В последнем примере нужно покрыть тестами функцию Family.AddNew(). Важно учесть в тестах как положительный сценарий (когда добавляется новый член семьи), так и отрицательный (когда возникает ошибка при добавлении).*/
